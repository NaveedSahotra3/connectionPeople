...
import 'package:flutterconnecct/listscreens/addfreeitem2.dart';
...
class ListFreeItemScreens extends StatefulWidget{
  String userid;
  String needid;
  String btntitle;
  ListFreeItemScreens(String _id,String _needid,String title){
    userid  = _id;
    needid = _needid;
    btntitle = title;
  }
  _ListFreeItemScreens createState() => new _ListFreeItemScreens();
}

class _ListFreeItemScreens extends State<ListFreeItemScreens>{
  ...
  void initState() {
    ...
    itemRefShop = database.reference().child('free_items');
  ...
  _onEntryAddedShop(Event event) {
    setState(() {
      itemsShop.add(FreeNeeds.fromSnapshot(event.snapshot));
    });
  }

  _onEntryChangedShop(Event event) {
    var old = itemsShop.singleWhere((entry) {
      return entry.donor_id == event.snapshot.key;
    });
    setState(() {
      itemsShop[itemsShop.indexOf(old)] = FreeNeeds.fromSnapshot(event.snapshot);
    });
  }

  List<FreeNeeds> itemsShop = List();
  FreeNeeds itemShop;
                  ...
                  children: [
                    ...
                    Container(
                        ...
                        child: FlatButton(
                          ...
                          onPressed: (){
                            Navigator.push(context, MaterialPageRoute(builder: (context) => AddFreeItem(MyApp.profileDetails.userid)),);
                          },
              ...
              Container(
                ...
                child: itemsShop.length==0 ?Center(
                  ...
                  itemBuilder: (context,index){
                    ...
                    return   FreeItemWidget(itemsShop[index]);

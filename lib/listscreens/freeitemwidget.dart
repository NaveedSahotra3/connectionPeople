...
class FreeItemWidget extends StatefulWidget {

  FreeNeeds userNeeds;

  FreeItemWidget(FreeNeeds _userNeeds) {
    userNeeds = _userNeeds;
  }

  _FreeItemWidget createState() => new _FreeItemWidget();
}


class _FreeItemWidget extends State<FreeItemWidget>{

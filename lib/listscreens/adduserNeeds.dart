...
class AddUserNeeds extends StatefulWidget{

 String userid;
 String title;
 String needid;

 AddUserNeeds(String _a,String _b, String _c){
   userid= _a;
   title= _b;
   needid= _c;
  }
  _AddUserNeeds createState() => new _AddUserNeeds();
}

class _AddUserNeeds extends State<AddUserNeeds>{
                        ...
                        Container(
                          ...
                          child: TextField(
                            ...
                            decoration: new InputDecoration(
                                ...
                                hintText: "Type Your Personal Need"),
                          ),
                        ),

                              ...
                              Text("First Name: ",
                               ...
                               Container(
                                 ...
                                 decoration: new BoxDecoration(
                                   color: Colors.white,
                                   border: new Border(
                                     bottom: new BorderSide(color: Colors.black45, style: BorderStyle.solid),
                                   ),
                                 ),
                                 child: TextField(
                                   controller: txtfname,
                               ...
                               Container(
                                 ...
                                 child: FlatButton(
                                   ...
                                   onPressed: (){
                                     ...
                                     if(txtlname.text==""){
                                          _response="Enter Last Name First";
                                     }
                                     else if(txtfname.text==""){
                                       _response="Enter First Name First";
                                     }
                                     else{
                                       MyApp.profileDetails.firstName = txtfname.text;
                                       MyApp.profileDetails.lastName = txtlname.text;

                                       Navigator.of(context).push(MaterialPageRoute(builder: (context) => SelectLanguage(widget.id.toString())));
                                     }

...
import 'package:flutterconnecct/screens/homerepair.dart';
...
class ClothingNeeds extends StatefulWidget{

  ProfileDetails _profileDetails;
  ClothingNeeds(ProfileDetails _id){
    _profileDetails= _id;
  }
  __ClothingNeeds createState()=> new __ClothingNeeds();
}

class __ClothingNeeds extends State<ClothingNeeds>{
                    ...
                    child: Column(
                      children: [
                        Container(
                          width: screenWidth,
                          padding: EdgeInsets.only(top: 10,),
                          child: Text("What are your clothing needs ?",
                            textAlign: TextAlign.center,
                            style: TextStyle(
                                fontSize: 16,
                                fontWeight: FontWeight.bold,
                        ...
                        Container(
                            ...
                            child: FlatButton(
                              ...
                              onPressed: (){
                                Navigator.of(context).push(MaterialPageRoute(builder: (context) =>  HomeRepair(MyApp.profileDetails)));

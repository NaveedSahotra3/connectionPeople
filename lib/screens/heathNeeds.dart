...
class HealthNeeds extends StatefulWidget{
  ...
  HealthNeeds(ProfileDetails _id){
    _profileDetails= _id;
  }
  _HealthNeeds createState() => new _HealthNeeds();
}

class _HealthNeeds extends State<HealthNeeds>{
                    ...
                    child: Column(
                      children: [
                        Container(
                          width: screenWidth,
                          padding: EdgeInsets.only(top: 10,),
                          child: Text("What are your health needs ?",
                            textAlign: TextAlign.center,
                            style: TextStyle(
                                fontSize: 16,
                                fontWeight: FontWeight.bold,
                        ...
                        Container(
                            ...
                            child: FlatButton(
                              ...
                              onPressed: (){
                                Navigator.of(context).push(MaterialPageRoute(builder: (context) =>  ChildNeeds(MyApp.profileDetails)));

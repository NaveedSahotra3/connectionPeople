...
class _ContactUs extends State<ContactUs>{
  ...
  final dbRef = FirebaseDatabase.instance.reference().child("feedback_messages");
          ...
          child: ListView(
           shrinkWrap: true,
            children: [
              ...
              Container(
                padding: EdgeInsets.all( 2),
                child: Text("Support@ConnectingPeopleinNeed.com",
                  textAlign: TextAlign.center,
                  style: TextStyle(
                      fontSize: 16,
                              ...
                              dbRef.push().set(
                                {
                                  ...
                                  "user_id": MyApp.profileDetails.userid.toString()
                                }
                              ).then((_) {

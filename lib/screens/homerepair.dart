...
class HomeRepair extends StatefulWidget{
  ...
  HomeRepair(ProfileDetails _id){
    _profileDetails= _id;
  }
  _HomeRepair createState()=> new _HomeRepair();
}

class _HomeRepair extends State<HomeRepair>{
                    ...
                    child: Column(
                      children: [
                        Container(
                          width: screenWidth,
                          padding: EdgeInsets.only(top: 10,),
                          child: Text("What are your home repair needs ?",
                            textAlign: TextAlign.center,
                            style: TextStyle(
                                fontSize: 16,
                                fontWeight: FontWeight.bold,
                        ...
                        Container(
                            ...
                            child: FlatButton(
                              ...
                              onPressed: (){
                                Navigator.of(context).push(MaterialPageRoute(builder: (context) =>  MainScreen(MyApp.profileDetails.userid.toString())));

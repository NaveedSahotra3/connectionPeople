...
class TutoringNeeds extends StatefulWidget{

  ProfileDetails _profileDetails;
  TutoringNeeds(ProfileDetails _id){
    _profileDetails= _id;
  }
  _TutoringNeeds createState() => new _TutoringNeeds();
}

class _TutoringNeeds extends State<TutoringNeeds>{
                    ...
                    child: Column(
                      children: [
                        Container(
                          width: screenWidth,
                          padding: EdgeInsets.only(top: 10,),
                          child: Text("What are your tutoring needs ?",
                            textAlign: TextAlign.center,
                            style: TextStyle(
                                fontSize: 16,
                                fontWeight: FontWeight.bold,
                        ...
                        Container(
                            ...
                            child: FlatButton(
                              ...
                              onPressed: (){
                                Navigator.of(context).push(MaterialPageRoute(builder: (context) =>  ShelterNeeds(MyApp.profileDetails)));

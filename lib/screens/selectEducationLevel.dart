...
class SelectEducationlevel extends StatefulWidget{
  ...
  String id;
  SelectEducationlevel(String _id){
    id= _id;
  }
  __SelectEducationlevel createState() => new __SelectEducationlevel();

}

class __SelectEducationlevel extends State<SelectEducationlevel>{
  ...
  List<EducationLevel> itemsShop = List();
  EducationLevel itemShop;
  ...
  void initState() {
    ...
    itemShop = EducationLevel();
    final FirebaseDatabase database = FirebaseDatabase.instance;
    itemRefShop = database.reference().child('education_levels');
  ...
  _onEntryAddedShop(Event event) {
    setState(() {
      itemsShop.add(EducationLevel.fromSnapshot(event.snapshot));
    });
  }

  _onEntryChangedShop(Event event) {
    var old = itemsShop.singleWhere((entry) {
      return entry.id_level == event.snapshot.key;
    });
    setState(() {
      itemsShop[itemsShop.indexOf(old)] = EducationLevel.fromSnapshot(event.snapshot);
    });
  }
  ...
  EducationLevel selectedUser;

  setSelectedUser(EducationLevel user) {
    setState(() {
      selectedUser = user;
    });
  }
              ...
              children: [
                ...
                Container(
                    ...
                    child: FlatButton(
                      ...
                      onPressed: (){
                        MyApp.profileDetails.educationLevel = selectedUser.description.toString();
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) => Selectethnicities(widget.id.toString())));
                      },

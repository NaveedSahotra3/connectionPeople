...
import 'package:flutterconnecct/screens/childneeds.dart';
import 'package:flutterconnecct/screens/clothingneeds.dart';
...
import 'package:flutterconnecct/screens/foodNeeds.dart';
...
class TechnologyNeeds extends StatefulWidget{

  ProfileDetails _profileDetails;
  TechnologyNeeds(ProfileDetails _id){
    _profileDetails= _id;
  }
  __TechnologyNeeds createState()=> new __TechnologyNeeds();
}

class __TechnologyNeeds extends State<TechnologyNeeds>{
                    ...
                    child: Column(
                      children: [
                        Container(
                          width: screenWidth,
                          padding: EdgeInsets.only(top: 10,),
                          child: Text("What are your technology needs ?",
                            textAlign: TextAlign.center,
                            style: TextStyle(
                                fontSize: 16,
                                fontWeight: FontWeight.bold,
                        ...
                        Container(
                            ...
                            child: FlatButton(
                              ...
                              onPressed: (){
                                Navigator.of(context).push(MaterialPageRoute(builder: (context) =>  ClothingNeeds(MyApp.profileDetails)));

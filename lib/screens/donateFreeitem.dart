...
class SelectDonateFreeItem extends StatefulWidget{

  ProfileDetails _profileDetails;
  SelectDonateFreeItem(ProfileDetails _id){
    _profileDetails= _id;
  }
  __SelectDonateFreeItem createState() => new __SelectDonateFreeItem();
}

class __SelectDonateFreeItem extends State<SelectDonateFreeItem>{
  ...
  var _firebaseRef = FirebaseDatabase().reference().child('free_items');
                      ...
                      child: _image == null
                       ...
                       Container(
                           ...
                           child: FlatButton(
                             ...
                             onPressed: (){
                               Navigator.of(context).push(MaterialPageRoute(builder: (context) => EmployeementNeeds(MyApp.profileDetails)));
                                      },
  ...
  Future<String> addImageToFirebase() async{
   ...
   uploadToFirebase (String purl) {
    ...
    _firebaseRef.child(userkey).set({
      ...
      "donor_id": MyApp.profileDetails.userid.toString(),
      "status": "1",
      "timestamp": DateTime.now().millisecondsSinceEpoch
        ...
        _firebaseRef.child(userkey).child("/geolocation").set({
          ...
          _firebaseRef.child(userkey).child("/geolocation/extras").set({
            ...
            Navigator.push(context, MaterialPageRoute(builder: (context) => EmployeementNeeds(MyApp.profileDetails)),);
          });

...
class TransportationNeeds extends StatefulWidget{

  ProfileDetails _profileDetails;
  TransportationNeeds(ProfileDetails _id){
    _profileDetails= _id;
  }
  _TransportationNeeds createState() => new _TransportationNeeds();
}

class _TransportationNeeds extends State<TransportationNeeds>{
                    ...
                    child: Column(
                      children: [
                        Container(
                          width: screenWidth,
                          padding: EdgeInsets.only(top: 10,),
                          child: Text("What are your transportation needs ?",
                            textAlign: TextAlign.center,
                            style: TextStyle(
                                fontSize: 16,
                                fontWeight: FontWeight.bold,
    ...
    _firebaseRef.child(userkey).set({
      ...
      _firebaseRef.child(userkey).child("/geolocation").set({
        ...
        _firebaseRef.child(userkey).child("/geolocation/extras").set({
          ...
          deleteImage();
          txtempneeds.text="";
          Navigator.of(context).push(MaterialPageRoute(builder: (context) => FoodNeeds(MyApp.profileDetails)));
        });
      });

...
import 'package:flutterconnecct/screens/technologyneeds.dart';
...
class ShelterNeeds extends StatefulWidget{

  ProfileDetails _profileDetails;
  ShelterNeeds(ProfileDetails _id){
    _profileDetails= _id;
  }
  __ShelterNeeds createState()=> new __ShelterNeeds();
}

class __ShelterNeeds extends State<ShelterNeeds>{
                    ...
                    child: Column(
                      children: [
                        Container(
                          width: screenWidth,
                          padding: EdgeInsets.only(top: 10,),
                          child: Text("What are your shelter needs ?",
                            textAlign: TextAlign.center,
                            style: TextStyle(
                                fontSize: 16,
                                fontWeight: FontWeight.bold,
                        ...
                        Container(
                            ...
                            child: FlatButton(
                              ...
                              onPressed: (){
                                Navigator.of(context).push(MaterialPageRoute(builder: (context) =>  TechnologyNeeds(MyApp.profileDetails)));

...
class ChildNeeds extends StatefulWidget{
  ...
  ChildNeeds(ProfileDetails _id){
    _profileDetails= _id;
  }
  _ChildNeeds createState() => new _ChildNeeds();
}

class _ChildNeeds extends State<ChildNeeds>{
                    ...
                    child: Column(
                      children: [
                        Container(
                          width: screenWidth,
                          padding: EdgeInsets.only(top: 10,),
                          child: Text("What are your child needs ?",
                            textAlign: TextAlign.center,
                            style: TextStyle(
                                fontSize: 16,
                                fontWeight: FontWeight.bold,
                        ...
                        Container(
                            ...
                            child: FlatButton(
                              ...
                              onPressed: (){
                                Navigator.of(context).push(MaterialPageRoute(builder: (context) =>  TutoringNeeds(MyApp.profileDetails)));

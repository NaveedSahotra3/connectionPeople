...
import 'package:flutterconnecct/screens/heathNeeds.dart';
...
class FoodNeeds extends StatefulWidget{

  ProfileDetails _profileDetails;
  FoodNeeds(ProfileDetails _id){
    _profileDetails= _id;
  }
  _FoodNeeds createState() => new _FoodNeeds();
}

class _FoodNeeds extends State<FoodNeeds>{
                    ...
                    child: Column(
                      children: [
                        Container(
                          width: screenWidth,
                          padding: EdgeInsets.only(top: 10,),
                          child: Text("What are your food needs ?",
                            textAlign: TextAlign.center,
                            style: TextStyle(
                                fontSize: 16,
                                fontWeight: FontWeight.bold,
                        ...
                        Container(
                            ...
                            child: FlatButton(
                              ...
                              onPressed: (){
                                Navigator.of(context).push(MaterialPageRoute(builder: (context) =>  HealthNeeds (MyApp.profileDetails)));
                                },

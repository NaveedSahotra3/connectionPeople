...
class _MyNeeds extends State<MyNeeds>{
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: TabBarView(
           children: [
             myneeds(context),
             myfullfilled(context),
             myotherneeds(context),
             mymovements(context)
           ],
         ),
 ...
 //------------------------------------------------------------------------------------------------------------
  Widget  myneeds(BuildContext context){
    return Container(
        child: Column(
...
//------------------------------------------------------------------------------------------------------------
Widget  myfullfilled(BuildContext context){
  return Container(
    child: Column(
...
//------------------------------------------------------------------------------------------------------------
Widget  myotherneeds(BuildContext context){
  return Container(
    child: Column(
...
//------------------------------------------------------------------------------------------------------------
Widget  mymovements(BuildContext context){
  return Container(
    child: ListView(
